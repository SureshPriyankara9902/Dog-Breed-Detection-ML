...
import Control.Receptionist_RegisterController;
...
public class Add_Receptionist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(720, 560, 120, 40);
        ...
        jLabel6.setBounds(530, 560, 120, 40);
        ...
        panelRound2.setBounds(530, 560, 120, 40);
        ...
        panelRound1.setBounds(720, 560, 120, 40);
        ...
        contactno.setBounds(350, 380, 350, 30);
...
if (id.getText().trim().isEmpty() || username.getText().trim().isEmpty()||password.getText().trim().isEmpty() ){
               ...
               Receptionist_RegisterController.Form(id.getText(), name.getText(),gender, NIC.getText(), contactno.getText(), username.getText(),password.getText());
clearField(); 
this.setVisible(false);
             }
