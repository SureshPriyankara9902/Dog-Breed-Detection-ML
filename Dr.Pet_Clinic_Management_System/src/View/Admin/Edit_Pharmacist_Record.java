...
import Control.Pharmacist_EditController;
 ...
 */
public class Edit_Pharmacist_Record extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Dashboard
     */
    String uname;
    public Edit_Pharmacist_Record(String user_name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        panelRound12Layout.setVerticalGroup(
            ...
            .addGroup(panelRound12Layout.createSequentialGroup()
                .addComponent(panelRound13, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
                .addGap(5, 5, 5))
        );

        getContentPane().add(panelRound12);
        panelRound12.setBounds(30, 350, 1140, 200);
        ...
        edit.setBounds(1010, 560, 115, 33);
        ...
        name1.setBounds(670, 150, 410, 30);
        ...
        female2.setBounds(310, 200, 101, 30);
        ...
        Dashboard.setText("Edit Pharmacist Record");
        getContentPane().add(Dashboard);
        Dashboard.setBounds(150, 80, 290, 31);
...
if (id1.getText().trim().isEmpty() || username2.getText().trim().isEmpty()||password2.getText().trim().isEmpty() ){
     ...
     Pharmacist_EditController.Form(id1.getText(), name1.getText(),gender,NIC2.getText(),contactno2.getText(), username2.getText(), password2.getText());
        this.setVisible(false);
             }
  ...
  contactno2.setEditable(true);   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_Pharmacist_Record.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            String user_name;
            public void run() {
                new Edit_Pharmacist_Record(user_name).setVisible(true);
            }
        });
    }
